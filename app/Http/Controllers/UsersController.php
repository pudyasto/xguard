    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'factory_uuid'  => ['required', 'string', 'max:50'],
            ...
            $pegawai = DB::connection('mdware')->table('absen_all')->where('status', 'aktif')->where('nik', $request->username)->first();
            $this->response = User::create([
                ...
                'department'        => $pegawai->subdept,
                'factory_uuid'      => $request->factory_uuid,
